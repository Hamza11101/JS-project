...
function f1(){
    var wo1=``;
        let  worke  =z.filter(x => x.work == "Front-end" );
        console.log(worke);
        ...
        wo1 += `<div class="card-body pt-4 p-3">
            ...
            document.getElementById("fro").innerHTML= wo1

        });
            

    var wo2=``
    let  wor  =z.filter(x => x.work == "Back-end" );
        console.log(wor);
        ...
        wor.forEach(elm => {
          ...
          document.getElementById("bac").innerHTML= wo2

      });

      var wo3=``
      let  wore  =z.filter(x => x.work == "Fullstuck" );
          console.log(wore);
          ...
          document.getElementById("ful").innerHTML= wo3
