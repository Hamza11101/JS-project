...
function f1(){
    var wo1=``;
        let  worke  =z.filter(x => x.work == "Doctor" );
        console.log(worke);
        ...
        wo1 += `<div class="card-body pt-4 p-3">
            ...
            document.getElementById("doc").innerHTML= wo1

        });
            

    var wo2=``
    let  wor  =z.filter(x => x.work == "Dentist" );
        console.log(wor);
        ...
        wor.forEach(elm => {
          ...
          document.getElementById("den").innerHTML= wo2

      });

      var wo3=``
      let  wore  =z.filter(x => x.work == "Nurse" );
          console.log(wore);
          ...
          document.getElementById("nur").innerHTML= wo3
