...
function f1(){
    var wo1=``;
        let  worke  =z.filter(x => x.work == "Electrician" );
        console.log(worke);
        ...
        wo1 += `<div class="card-body pt-4 p-3">
            ...
            document.getElementById("ele").innerHTML= wo1

        });
            

    var wo2=``
    let  wor  =z.filter(x => x.work == "Plumber" );
        console.log(wor);
        ...
        wor.forEach(elm => {
          ...
          document.getElementById("plu").innerHTML= wo2

      });

      var wo3=``
      let  wore  =z.filter(x => x.work == "Carpenter" );
          console.log(wore);
          ...
          document.getElementById("car").innerHTML= wo3

      });
      var wo4=``
      let  woree  =z.filter(x => x.work == "Garden worker" );
          console.log(woree);
          
          woree.forEach(eleme => {
            wo4 += `<div class="card-body pt-4 p-3">
            <ul class="list-group">
              <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                <div class="d-flex flex-column">
                  <h6 class="mb-3 text-sm">${eleme.fname+" "+eleme.lname}</h6><br>
                  <span class="mb-2 text-xs">Email Address: <span class="text-dark font-weight-bold ms-sm-2">${eleme.email}</span></span><br>
                  <span class="mb-2 text-xs">Mobile Number: <span class="text-dark ms-sm-2 font-weight-bold">${eleme.mobile}</span></span><br>
                  <span class="text-xs">Function : <span class="text-dark ms-sm-2 font-weight-bold">${eleme.work}</span></span><br>
                </div>
          ...
          document.getElementById("gar").innerHTML= wo4
